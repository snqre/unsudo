...
mod sig_test {
    ...
    fn success() {
        bind!(async "/src/lib.js"::test_0(a: u8, b: u8, c: u8) -> u8);
        bind!(async "/src/lib.js"::test_1(a: u8, b: u8, c: u8));
        bind!(async "/src/lib.js"::test_2() -> u8);
        bind!(async "/src/lib.js"::test_3());        
        bind!("/src/lib.js"::test_4(a: u8, b: u8, c: u8) -> u8);
        bind!("/src/lib.js"::test_5(a: u8, b: u8, c: u8));
        bind!("/src/lib.js"::test_6() -> u8);
        bind!("/src/lib.js"::test_7());
